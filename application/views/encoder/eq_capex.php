...
<div class="main-content">
                ...
                <div class="card">
                    <div class="card-header bg-blue">
                        ...
                        if($this->session->type == 'encoder')
                            {
                        ?>
                        <div class="card-header-action" data-toggle="modal" data-target="#newEqCapexForm">
    ...
    <!-- Modal form for a new capex equipment-->
    <div class="modal fade" id="newEqCapexForm" tabindex="-1" role="dialog" aria-labelledby="formModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="<?=site_url('encoder/new_eq')?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="category_id" value="<?=$eq_capex[0]->id_category?>" hidden>
                    ...
                    <input type="hidden" name="type" value="eq_capex">
